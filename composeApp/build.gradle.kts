...
tasks.register<Jar>("stripSignaturesFromUberJar") {
    ...
    val uberJarPath = layout.buildDirectory.file("compose/jars/MacroKapServer-linux-x64-1.1.2.jar")
    
    archiveFileName.set("MacroKapServer-linux-x64-1.1.2-unsigned.jar")
