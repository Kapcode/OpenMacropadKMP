...
open class SettingsViewModel {
    ...
    fun chooseMacroDirectory() {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            // Save the setting to the properties file via com.kapcode.open.macropad.kmps.desktop.AppSettings
    ...
    fun resetPairedDevices() {
        com.kapcode.open.macropad.kmps.desktop.logic.TrustedDeviceManager.getTrustedDevices().keys.forEach { id ->
            com.kapcode.open.macropad.kmps.desktop.logic.TrustedDeviceManager.removeTrustedDevice(id)
        }
    }

    fun resetBannedDevices() {
        com.kapcode.open.macropad.kmps.desktop.logic.TrustedDeviceManager.unbanAllDevices()
        com.kapcode.open.macropad.kmps.desktop.logic.PairingBanManager.clearAllBans()
    }

    fun revokeProStatus() {
        com.kapcode.open.macropad.kmps.desktop.logic.ProAccessManager.revokeProAccess()
    }
}