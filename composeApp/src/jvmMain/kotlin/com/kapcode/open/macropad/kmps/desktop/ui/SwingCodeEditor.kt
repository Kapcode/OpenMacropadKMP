...
fun SwingCodeEditor(
    ...
    var textAreaRef by remember { mutableStateOf<RSyntaxTextArea?>(null) }
    var listenerRef by remember { mutableStateOf<DocumentListener?>(null) }

    DisposableEffect(Unit) {
        onDispose {
            textAreaRef?.let { textArea ->
