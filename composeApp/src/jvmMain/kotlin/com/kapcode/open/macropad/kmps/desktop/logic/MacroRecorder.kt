...
import com.kapcode.open.macropad.kmps.desktop.viewmodel.RecordMacroViewModel
...
class MacroRecorder(
    ...
    private fun stop() {
        ...
        when (options.triggerType.value) {
            com.kapcode.open.macropad.kmps.desktop.model.TriggerType.HOLD -> triggerJson.put("durationMs", options.holdDurationMs.value.toLongOrNull() ?: 500)
            com.kapcode.open.macropad.kmps.desktop.model.TriggerType.MULTI_TAP -> {
            ...
            com.kapcode.open.macropad.kmps.desktop.model.TriggerType.SEQUENCE -> triggerJson.put("windowMs", options.sequenceWindowMs.value.toLongOrNull() ?: 1000)
            else -> {}
        }
