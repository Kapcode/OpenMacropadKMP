...
object KeyParser {
    ...
    private val nativeHookKeyMap = mapOf(
        ...
        "0" to NativeKeyEvent.VC_0, "1" to NativeKeyEvent.VC_1, "2" to NativeKeyEvent.VC_2, "3" to NativeKeyEvent.VC_3, "4" to NativeKeyEvent.VC_4,
        "5" to NativeKeyEvent.VC_5, "6" to NativeKeyEvent.VC_6, "7" to NativeKeyEvent.VC_7, "8" to NativeKeyEvent.VC_8, "9" to NativeKeyEvent.VC_9,
        "WINDOWS" to NativeKeyEvent.VC_META, "WIN" to NativeKeyEvent.VC_META, "META" to NativeKeyEvent.VC_META,
